...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivProduct,
      @NonNull ImageView ivWishlist, @NonNull TextView tvCategory, @NonNull TextView tvName,
      @NonNull TextView tvPrice, @NonNull TextView tvSeller) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, ivProduct, ivWishlist, tvCategory,
          tvName, tvPrice, tvSeller);
    }
